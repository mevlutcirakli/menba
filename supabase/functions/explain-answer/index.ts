...
serve(async (req) => {
    ...
    try {
        ...
        const prompt =
            'Asagidaki coktan secmeli soru icin ogrenciye kisa bir ogretici aciklama yap. ' +
            'Neden verdigi cevabin yanlis oldugunu, dogru secenegin mantigini ve bir mini ipucu ver. ' +
            'Sadece tek bir aciklama metni dondur.\n\n' +
            `Soru: ${question}\n` +
            `Ogrencinin cevabi: ${userAnswer}\n` +
            `Dogru cevap: ${correctAnswer}`;
